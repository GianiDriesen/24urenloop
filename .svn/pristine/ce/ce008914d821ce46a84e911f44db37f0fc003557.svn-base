...
public class TeamAchievement implements Achievement {
    private int id;
    private String name;
    ...
    public TeamAchievement(JSONObject obj) {
        try {
    ...
    public TeamAchievement(String name, String description) {
        this.name = name;
        this.description = description;
    }

    public TeamAchievement(int id, String name, String description) {
        this.id = id;
        this.name = name;
        this.description = description;
    }
    ...
    public List<String> getExportableFields() {
        ...
        fields.add("This achievement is for Teams");
