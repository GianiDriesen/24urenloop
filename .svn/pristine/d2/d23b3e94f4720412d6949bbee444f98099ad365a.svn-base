...
public class AdminChronometerActivity extends AppCompatActivity {
    ...
    private void setupViews() {
        Toolbar toolbar = (Toolbar) findViewById(R.id.admin_chronometer_toolbar);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.admin_chronometer_nav);
    ...
    public void startClock(View v) {
        ...
        if (queue.isEmpty()) {
            Toast.makeText(app.getApplicationContext(), "You can't run, there are no runners!", Toast.LENGTH_LONG).show();
            chronometer.stop();
