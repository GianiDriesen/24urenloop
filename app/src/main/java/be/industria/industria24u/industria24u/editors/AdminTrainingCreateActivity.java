...
public class AdminTrainingCreateActivity extends AppCompatActivity {
    ...
    private void setupViews() {
        Toolbar toolbar = (Toolbar) findViewById(R.id.admin_training_create_toolbar);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.admin_training_create_nav);
