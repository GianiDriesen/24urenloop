...
public class AdminAchievementEditActivity extends AppCompatActivity implements OnItemSelectedListener {
    ...
    public void setupViews() {
        Toolbar toolbar = (Toolbar) findViewById(R.id.admin_achievement_edit_toolbar);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.admin_achievement_edit_nav);
